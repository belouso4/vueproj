...
var Editor = /*#__PURE__*/function () {
  ...
  _createClass(Editor, [{
    ...
    value: function open(page) {
      ...
      _axios["default"].get('../' + page).then(function (res) {
    ...
    value: function enableEditing() {
      ...
      this.iframe.contentDocument.body.querySelectorAll("text-editor").forEach(function (el) {
        ...
        el.addEventListener("input", function () {
          _this2.onTextEdit(el);
        });
      });
    }
  }, {
    key: "onTextEdit",
    value: function onTextEdit(el) {
      var id = el.getAttribute("nodeid");
      _domHelper["default"].virtualDom.body.querySelector("[nodeid=\"".concat(id, "\"]")).innerHTML = el.innerHTML;
    }
  }, {
    key: "save",
    value: function save() {
